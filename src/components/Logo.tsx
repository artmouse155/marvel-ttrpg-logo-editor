...
export const Logo = (props: Props) => {
    return (
        ...
        >
            <defs>
                <linearGradient id={`${props.id}-gradient-colors`}>
                    <stop
                        offset={0}
                        style={{
                            stopColor: props.colors.flameBaseColor,
                            stopOpacity: 1,
                        }}
                    />
                    <stop
                        offset={1}
                        style={{
                            stopColor: props.colors.flameTipColor,
                            stopOpacity: 1,
                        }}
                    />
                </linearGradient>
                <linearGradient
                    xlinkHref={`#${props.id}-gradient-colors`}
                    id={`${props.id}-g1`}
                    x1={166.526}
                    x2={166.526}
                    y1={233.076}
            ...
            >
                <path
                    ...
                    style={{
                        display: "inline",
                        fill: props.colors.backgroundColor,
                        fillOpacity: 1,
                ...
                <path
                    ...
                    style={{
                        fill: `url(#${props.id}-g1)`,
                        fillOpacity: 1,
                        strokeWidth: 0.252787,
                    }}
                    transform="translate(-109.402 -174.75)"
                />
                <path
                    ...
                    style={{
                        fill: `url(#${props.id}-g2)`,
                        fillOpacity: 1,
                        strokeWidth: 0.264583,
                    }}
                    transform="translate(-109.402 -174.8)"
                />
                <g
                    style={{
                        fill: props.colors.letterColor,
                        fillOpacity: 1,
                    }}
                >
                    <path
